var ModuleFactory = (() => {
	...
	return async function (moduleArg = {}) {
		...
		var ASM_CONSTS = {
			...
			1485898: () => typeof HTMLCanvasElement !== "undefined",
			1485953: () => !!Module["preinitializedWebGPUDevice"],
			1486004: () => {
		...
		function assignWasmExports(wasmExports) {
			_free = Module["_free"] = wasmExports["kd"];
			_malloc = Module["_malloc"] = wasmExports["ld"];
			_wgpuDeviceAddRef = wasmExports["md"];
			_addBoundTextureAsImageToStream = Module["_addBoundTextureAsImageToStream"] = wasmExports["nd"];
			_attachImageListener = Module["_attachImageListener"] = wasmExports["od"];
			_attachImageVectorListener = Module["_attachImageVectorListener"] = wasmExports["pd"];
			...
			_emwgpuCreateBuffer = wasmExports["Pe"];
			...
			_emwgpuOnCreateRenderPipelineCompleted = wasmExports["Ue"];
			...
			__indirect_function_table = wasmTable = wasmExports["jd"];
		}
		...
		var wasmImports = {
			gd: BeginGlQueryTiming,
			fd: EndGlQueryTiming,
			ed: GetAdapterArchitecture,
			dd: GetAdapterDescription,
			cd: GetAdapterDeviceName,
			bd: GetAdapterVendor,
			ad: JsOnEmptyPacketListener,
			$c: JsOnFloat32ArrayImageListener,
			_c: JsOnFloat32ArrayImageVectorListener,
			ob: JsOnSimpleListenerBinaryArray,
			Zc: JsOnSimpleListenerBool,
			Yc: JsOnSimpleListenerDouble,
			Xc: JsOnSimpleListenerFloat,
			Wc: JsOnSimpleListenerInt,
			Vc: JsOnSimpleListenerString,
			Uc: JsOnSimpleListenerUint,
			Tc: JsOnUint8ArrayImageListener,
			Sc: JsOnUint8ArrayImageVectorListener,
			O: JsOnVectorFinishedListener,
			Rc: JsOnVectorListenerBool,
			Qc: JsOnVectorListenerDouble,
			Pc: JsOnVectorListenerFloat,
			Oc: JsOnVectorListenerInt,
			Nc: JsOnVectorListenerProto,
			Mc: JsOnVectorListenerString,
			Lc: JsOnVectorListenerUint,
			Kc: JsOnWebGLTextureListener,
			Jc: JsOnWebGLTextureVectorListener,
			Oa: JsWrapErrorListener,
			nb: JsWrapImageConverter,
			u: JsWrapSimpleListeners,
			mb: UseBottomLeftGpuOrigin,
			xb: __asyncjs__mediapipe_map_buffer_jspi,
			o: ___cxa_throw,
			Ic: ___syscall_dup,
			Hc: ___syscall_faccessat,
			lb: ___syscall_fcntl64,
			Gc: ___syscall_fstat64,
			Lb: ___syscall_ftruncate64,
			Fc: ___syscall_ioctl,
			Ec: ___syscall_lstat64,
			Dc: ___syscall_newfstatat,
			kb: ___syscall_openat,
			Cc: ___syscall_stat64,
			xc: __abort_js,
			Ib: __embind_register_bigint,
			...
			uc: __embind_register_std_string,
			La: __embind_register_std_wstring,
			tc: __embind_register_void,
			$: __emval_create_invoker,
			q: __emval_decref,
			Ka: __emval_get_global,
			hb: __emval_get_property,
			ja: __emval_incref,
			Ja: __emval_instanceof,
			_: __emval_invoke,
			ua: __emval_new_cstring,
			Z: __emval_run_destructors,
			gb: __emval_set_property,
			sc: __emval_typeof,
			Hb: __gmtime_js,
			Gb: __localtime_js,
			Fb: __mktime_js,
			...
			rc: __tzset_js,
			Kb: _clock_time_get,
			qc: custom_emscripten_dbgn,
			Y: _emscripten_asm_const_int,
			fb: _emscripten_asm_const_ptr,
			Ia: _emscripten_errn,
			pc: _emscripten_get_heap_max,
			y: _emscripten_get_now,
			ia: _emscripten_has_asyncify,
			oc: _emscripten_outn,
			nc: _emscripten_pc_get_function,
			mc: _emscripten_resize_heap,
			...
			hc: _emscripten_webgl_make_context_current,
			Q: _emscripten_webgpu_get_device,
			gc: _emwgpuBufferDestroy,
			fc: _emwgpuBufferGetMappedRange,
			ec: _emwgpuBufferUnmap,
			x: _emwgpuDelete,
			dc: _emwgpuDeviceCreateBuffer,
			Cb: _emwgpuDeviceCreateComputePipelineAsync,
			Bb: _emwgpuDeviceCreateRenderPipelineAsync,
			cc: _emwgpuDeviceCreateShaderModule,
			bc: _emwgpuDeviceDestroy,
			ac: _emwgpuWaitAny,
			Bc: _environ_get,
			Ac: _environ_sizes_get,
			db: _exit,
			Na: _fd_close,
			jb: _fd_read,
			Jb: _fd_seek,
			...
			Nb: _glUniformMatrix2fv,
			Mb: _glUniformMatrix3fv,
			Ga: _glUniformMatrix4fv,
			g: _glUseProgram,
			k: _glVertexAttribPointer,
			S: _glViewport,
			Ab: mediapipe_create_utility_canvas2d,
			zb: _mediapipe_find_canvas_event_target,
			yb: mediapipe_import_external_texture,
			wb: _mediapipe_webgl_tex_image_drawable,
			zc: _proc_exit,
			yc: _random_get,
			Fa: _wgpuCommandEncoderBeginComputePass,
			Ea: _wgpuCommandEncoderBeginRenderPass,
			vb: _wgpuCommandEncoderCopyBufferToTexture,
			ub: _wgpuCommandEncoderCopyTextureToBuffer,
			...
			sb: _wgpuDeviceCreateBindGroupLayout,
			K: _wgpuDeviceCreateCommandEncoder,
			rb: _wgpuDeviceCreateComputePipeline,
			qb: _wgpuDeviceCreatePipelineLayout,
			Ra: _wgpuDeviceCreateRenderPipeline,
			R: _wgpuDeviceCreateSampler,
			ba: _wgpuDeviceCreateTexture,
			J: _wgpuQueueSubmit,
			ka: _wgpuQueueWriteBuffer,
			pb: _wgpuQueueWriteTexture,
			...
			Qa: _wgpuRenderPipelineGetBindGroupLayout,
