...
import { preloadBackgroundEffectsModel, preloadBackgroundImages } from "../../effects/backgroundEffects.js";
...
import { cleanupAndNavigate as cleanupAndNavigateFn, setupBeforeUnload, handleStopScreen as handleStopScreenFn } from "./cleanup.js";
...
async function initFromUrl(appEl, ctx) {
	...
	if (join) {
		...
		if (identifier) {
			...
			const { hasPassword } = statusResult.success ? statusResult.data : { exists: false, hasPassword: true };
